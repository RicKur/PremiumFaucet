...
if($login->error == 0){
	...
	echo "\n".$jsn->Name."\n\n";
	echo "Bet Amount		: ".$jsn->Base_Bet."\n";
	echo "Change Bet if Lose	: ".$jsn->if_lose."\n";
	echo "Change bet if Win	: ".$jsn->if_win."\n";
	echo "Auto Win Chance		: ".$jsn->Min_winChance." - ".$jsn->Max_winChance." \n";
	echo "Auto Refresh if Profit	: ".$jsn->Refresh."\n";
	echo "Auto Stop If Profit	: ".$jsn->Stop_Profit."\n";
	echo "Auto Reset Bet win	: ".$jsn->Roll_win."\n";
	echo "Bet On			: ".$prt."\n\n";
